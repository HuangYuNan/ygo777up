...
function c5012616.initial_effect(c)
	...
	e1:SetCondition(c5012616.spcon)
	e1:SetOperation(c5012616.spop)
...
function c5012616.sumlimit(e,c,sump,sumtype,sumpos,targetp,se)
	return not c:IsSetCard(0x350)
end
function c5012616.ovfilter(c,g)
	return c:IsSetCard(0x350)  and c:IsFaceup() and c:IsLevelAbove(9) and c:IsCanBeXyzMaterial(g) and not c:IsType(TYPE_TOKEN)
end
