...
function c60150919.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,c60150919.tfilter,aux.NonTuner(c60150919.tfilter),2)
	c:EnableReviveLimit()
	--special summon rule
	...
	e12:SetCondition(c60150919.spcon2)
	e12:SetOperation(c60150919.spop2)
	c:RegisterEffect(e12)
	--negate
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(60150918,6))
...
function c60150919.sprfilter1(c,tp)
	...
	return c:IsFaceup() and c:IsType(TYPE_TOKEN) and c:IsSetCard(0x6b23) and c:IsCanBeSynchroMaterial()
		...
		or (c:IsFaceup() and c:IsType(TYPE_TOKEN) and c:IsSetCard(0x6b23) and lv==9)
end
