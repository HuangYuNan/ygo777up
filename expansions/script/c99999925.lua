--此世无存的幻马
function c99999925.initial_effect(c)
	c:SetUniqueOnField(1,0,99999925)
	--Activate
	...
	e1:SetTarget(c99999925.target)
	e1:SetOperation(c99999925.operation)
	c:RegisterEffect(e1)
	--Equip limit
	...
	e6:SetCondition(c99999925.accon)
	e6:SetOperation(c99999925.acop)
	c:RegisterEffect(e6)
end
function c99999925.eqlimit(e,c)
...
function c99999925.operation(e,tp,eg,ep,ev,re,r,rp)
...
function c99999925.accon(e,tp,eg,ep,ev,re,r,rp)
	return eg:GetFirst()==e:GetHandler():GetEquipTarget()
end
function c99999925.acop(e,tp,eg,ep,ev,re,r,rp)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetCode(EFFECT_CANNOT_ACTIVATE)
	e1:SetTargetRange(0,1)
	e1:SetValue(c99999925.aclimit)
	e1:SetReset(RESET_PHASE+PHASE_DAMAGE)
	Duel.RegisterEffect(e1,tp)
end
function c99999925.aclimit(e,re,tp)
