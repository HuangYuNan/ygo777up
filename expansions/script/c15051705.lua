...
function c15051705.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(100070,0))
	...
	e4:SetDescription(aux.Stringid(100070,1))
	...
	e5:SetDescription(aux.Stringid(100070,2))
	...
	e6:SetDescription(aux.Stringid(100070,3))
