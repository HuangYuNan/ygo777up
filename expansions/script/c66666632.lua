...
function c66666632.thop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringid(66666632,0)) and Duel.IsExistingMatchingCard(c66666632.spfilter,tp,LOCATION_HAND,0,1,nil)
	then 
		local g=Duel.SelectMatchingCard(tp,c66666632.spfilter,tp,LOCATION_HAND,0,1,1,nil)
