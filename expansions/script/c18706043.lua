...
function c18706043.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0xabb),2,2,c18706043.ovfilter,aux.Stringid(18706043,1),2)
	--special summon
...
function c18706043.ovfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xabb) and c:GetRank()==2 and not c:IsCode(18706043)
end
