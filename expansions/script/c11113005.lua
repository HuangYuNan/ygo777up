...
function c11113005.tfilter(c)
	return c:IsSetCard(0x15c) and c:GetType()==TYPE_SPELL+TYPE_RITUAL and c:IsAbleToHand()
end
...
function c11113005.thfilter(c)
	return c:IsSetCard(0x15c) and c:GetType()==TYPE_SPELL+TYPE_RITUAL and c:IsAbleToRemove()
end
