...
function c80005008.ffilter(c)
	return c:IsRace(RACE_SPELLCASTER) and c:GetTextAttack()==-2 and c:GetTextDefense()==-2 and not c:IsType(TYPE_PENDULUM)
end
...
function c80005008.spfilter1(c,tp)
	return c:IsRace(RACE_SPELLCASTER) and c:GetTextAttack()==-2 and c:GetTextDefense()==-2 and c:IsCanBeFusionMaterial() and Duel.CheckReleaseGroup(tp,c80005008.spfilter2,1,c) and not c:IsType(TYPE_PENDULUM)
end
function c80005008.spfilter2(c)
	return c:IsRace(RACE_SPELLCASTER) and c:GetTextAttack()==-2 and c:GetTextDefense()==-2 and c:IsCanBeFusionMaterial() and not c:IsType(TYPE_PENDULUM)
end
