...
function c80004026.initial_effect(c)
	...
	e3:SetCountLimit(1,80004026)
	e3:SetCondition(c80004026.drcon)
	e3:SetTarget(c80004026.drtg)
	e3:SetOperation(c80004026.drop)
	c:RegisterEffect(e3)  
end
function c80004026.filter(c,e,tp,m1,m2)
	if not c:IsSetCard(0x2dd) or bit.band(c:GetType(),0x81)~=0x81
...
function c80004026.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return Duel.IsExistingMatchingCard(c80004026.filter,tp,LOCATION_HAND,0,1,nil,e,tp,mg1,mg2)
	end
...
function c80004026.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=Duel.SelectMatchingCard(tp,c80004026.filter,tp,LOCATION_HAND,0,1,1,nil,e,tp,mg1,mg2)
