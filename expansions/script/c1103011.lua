...
function c1103011.initial_effect(c)
	...
	--disable attack
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(1103011,1))
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetHintTiming(0,TIMING_ATTACK)
	e1:SetRange(LOCATION_GRAVE)
	e1:SetCondition(c1103011.condition)
	e1:SetCost(c1103011.cost)
	e1:SetOperation(c1103011.operation)
	c:RegisterEffect(e1)
end
...
function c1103011.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c1103011.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToRemoveAsCost() end
	Duel.Remove(e:GetHandler(),POS_FACEUP,REASON_COST)
end
function c1103011.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetAttacker() then Duel.NegateAttack()
		...
		e1:SetCountLimit(1)
		e1:SetOperation(c1103011.disop)
		Duel.RegisterEffect(e1,tp)
	end
end
function c1103011.disop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,1103011)
	Duel.NegateAttack()
end
