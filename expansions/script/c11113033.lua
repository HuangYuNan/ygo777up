...
function c11113033.initial_effect(c)
	...
	e3:SetCondition(c11113033.atkcon)
	e3:SetOperation(c11113033.atkop)
	c:RegisterEffect(e3)
	--draw
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(11113033,1))
	e4:SetCategory(CATEGORY_DRAW)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e4:SetCode(EVENT_REMOVE)
	e4:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
	e4:SetCountLimit(1,11113033)
	e4:SetTarget(c11113033.drtg)
	e4:SetOperation(c11113033.drop)
	c:RegisterEffect(e4)
	--scale
...
function c11113033.atkcon(e,tp,eg,ep,ev,re,r,rp)
	return r==REASON_SYNCHRO and not re:GetHandler():IsSetCard(0x15c)
end
function c11113033.atkop(e,tp,eg,ep,ev,re,r,rp)
