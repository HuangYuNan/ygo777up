...
function c30303031.thtarget(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c30303031.filterc,tp,LOCATION_DECK,0,1,nil,tp) end
...
function c30303031.thoperation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c30303031.filterb,tp,LOCATION_DECK,0,1,1,nil)
