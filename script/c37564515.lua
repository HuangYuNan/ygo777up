...
function c37564515.sefilter(c,e,tp)
	...
	if c:GetOriginalCode()==37564765 then return true end
	return c:IsRace(RACE_FAIRY) and c:IsAttribute(ATTRIBUTE_LIGHT) and Duel.GetFieldGroupCount(tp,0,LOCATION_HAND)>0
end
