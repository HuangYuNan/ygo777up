...
function c11113010.initial_effect(c)
	...
	e1:SetCondition(c11113010.condition)
...
function c11113010.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c11113010.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c11113010.filter,tp,LOCATION_REMOVED,0,1,nil) end
