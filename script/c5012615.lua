...
function c5012615.thfilter(c)
	return (c:IsSetCard(0x350) or c:IsSetCard(0x23c) ) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function c5012615.refilter(c,tp)
	return  c:IsControler(tp) and (c:IsSetCard(0x350) or c:IsSetCard(0x23c) ) and c:IsType(TYPE_MONSTER)
end
