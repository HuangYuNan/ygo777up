...
function c18702305.condition(e)
...
function c18702305.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c18702305.filter,tp,LOCATION_GRAVE,0,1,nil,nil) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 end
