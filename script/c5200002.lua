...
function c5200002.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(5200002,2))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetHintTiming(0,TIMING_BATTLE_STEP_END)
	e1:SetRange(LOCATION_HAND)
	e1:SetCountLimit(1,5200002)
	...
	e2:SetDescription(aux.Stringid(5200002,1))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_SUMMON_SUCCESS)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
	e2:SetCountLimit(1,52000021)
...
--------------------------------------------------
function c5200002.spfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x360) 
end
function c5200002.spcon(c,e,tp,eg,ep,ev,re,r,rp)  
	return Duel.GetCurrentPhase()==PHASE_BATTLE_STEP and Duel.IsExistingMatchingCard(c5200002.spfilter,tp,LOCATION_MZONE,0,1,nil)
end
