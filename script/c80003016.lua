...
function c80003016.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		e:SetLabel(count)
		return count>0 and e:GetHandler():GetCounter(0x1c)>=count*3
	end
...
function c80003016.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RemoveCounter(ep,0x1c,count*3,REASON_EFFECT)
end