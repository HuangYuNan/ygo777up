...
function c18706031.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ep==tp or Duel.GetFieldGroup(tp,LOCATION_ONFIELD,0):Filter(c18706031.Fkfilter,nil):GetCount()~=Duel.GetFieldGroup(1-tp,LOCATION_ONFIELD,0):Filter(c18706031.Fkfilter,nil):GetCount() then return end
	end
