...
function c18730304.initial_effect(c)
	...
	e1:SetTarget(c18730304.target)
	e1:SetOperation(c18730304.activate)
	c:RegisterEffect(e1)
	--search
	local e1=Effect.CreateEffect(c)
...
function c18730304.filter3(c,e,tp,m)
...
function c18730304.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local mg1=Duel.GetRitualMaterial(tp)
		return Duel.IsExistingMatchingCard(c18730304.filter3,tp,LOCATION_HAND,0,1,nil,e,tp,mg1)
	end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND)
end
function c18730304.activate(e,tp,eg,ep,ev,re,r,rp)
	local mg1=Duel.GetRitualMaterial(tp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local tg=Duel.SelectMatchingCard(tp,c18730304.filter3,tp,LOCATION_HAND,0,1,1,nil,e,tp,mg1)
