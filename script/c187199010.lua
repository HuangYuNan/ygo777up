...
function c187199010.rmtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(c187199010.filter,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
	local g2=Duel.GetMatchingGroup(c187199010.filter2,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
