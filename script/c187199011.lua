...
function c187199011.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcFun2(c,aux.FilterBoolFunction(Card.IsSetCard,0x3e3),aux.FilterBoolFunction(Card.IsSetCard,0x3e1),true)
	--level change
	...
	e1:SetRange(LOCATION_MZONE)
	e1:SetValue(c187199011.efilter)
	c:RegisterEffect(e1)
end
function c187199011.efilter(e,te)
