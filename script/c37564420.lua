...
function c37564420.filter(c,e,tp)
	return c:IsSetCard(0x775) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and Duel.IsExistingMatchingCard(c37564420.filter2,tp,LOCATION_DECK,0,1,nil,c:GetCode())
end
...
function c37564420.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		if Duel.SpecialSummon(g,0,tp,tp,false,false,POS_FACEUP) and Duel.IsExistingMatchingCard(c37564420.filter2,tp,LOCATION_DECK,0,1,nil,g:GetFirst():GetCode()) then
