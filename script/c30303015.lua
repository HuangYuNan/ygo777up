...
function c30303015.initial_effect(c)
	...
	e1:SetCountLimit(1,30303015)
	e1:SetTarget(c30303015.thtg)
	e1:SetOperation(c30303015.thop)
	c:RegisterEffect(e1)
	--Activate
...
function c30303015.valcon(e,re,r,rp)
...
function c30303015.drcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c30303015.cfilter,tp,LOCATION_GRAVE,0,2,nil) end
	Duel.Hint(HINT_OPSELECTED,1-tp,e:GetDescription())
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(tp,c30303015.cfilter,tp,LOCATION_GRAVE,0,2,2,nil)
