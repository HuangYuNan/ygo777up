...
function c1000618.tdfilter(c,tp)
	...
	and c:GetReasonPlayer()==1-tp and c:IsAbleToDeck()
end
...
function c1000618.tg2(e,c)
	return c:IsSetCard(0xc204) and c:IsFaceup()
end
...
function c1000618.spfilter(c,e,tp)
	return  c:IsSetCard(0xc204) and c:IsType(TYPE_SYNCHRO) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
