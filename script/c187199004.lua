...
function c187199004.thfilter(c)
	return c:IsAbleToHand() and c:IsSetCard(0x3e1) and c:IsType(TYPE_MONSTER)
end
...
function c187199004.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingTarget(c187199004.afilter,tp,0,LOCATION_SZONE,1,nil) and Duel.IsEnvironment(187199010) end
