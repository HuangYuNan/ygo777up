...
function c2100008.initial_effect(c)
	...
	e2:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x1219))
	e2:SetValue(1000)
	c:RegisterEffect(e2)
	--Def
	local e3=e2:Clone()
...
function c2100008.spfilter(c)
	return c:IsSetCard(0x1219) and c:IsAbleToRemoveAsCost()
end
...
function c2100008.sumsuc(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x1219))
...
function c2100008.target(e,c)
	return c:IsSetCard(0x1219) and c:IsType(TYPE_MONSTER)
end
function c2100008.filter1(c,e,tp)
	return c:IsSetCard(0x1219) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
