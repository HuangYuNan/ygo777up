...
function c5012613.initial_effect(c)
	--synchro summon
	c:EnableReviveLimit()
	aux.AddSynchroProcedure2(c,nil,aux.FilterBoolFunction(c5012613.sfliter))
	--cannot trigger
	...
	local e16=e15:Clone()
	e16:SetCode(EFFECT_SET_DEFENCE)
...
function c5012613.tgfilter(c)
	return  not (c:IsSetCard(0x350) or c:IsSetCard(0x35a))  or c:IsFacedown()
end
...
function c5012613.hfilter(c)
	return  not (c:IsSetCard(0x350) or c:IsSetCard(0x35a) )
end
