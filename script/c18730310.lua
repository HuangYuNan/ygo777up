...
function c18730310.operation1(e,tp,eg,ep,ev,re,r,rp)
	...
	while rc do
		if rc:GetFlagEffect(18730310)==0 then
			...
			e1:SetCondition(c18730310.condition)
			e1:SetTarget(c18730310.distg)
...
function c18730310.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==e:GetHandlerPlayer()
end
function c18730310.distg(e,c)
	return (c:IsType(TYPE_EFFECT) or bit.band(c:GetOriginalType(),TYPE_EFFECT)==TYPE_EFFECT)
end
function c18730310.disop(e,tp,eg,ep,ev,re,r,rp)
