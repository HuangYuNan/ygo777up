...
function c80000166.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and 
		Duel.IsPlayerCanSpecialSummonMonster(tp,80000169,0x2d0,0x4011,c:GetBaseAttack(),c:GetBaseDefence(),c:GetOriginalLevel(),c:GetOriginalRace(),c:GetOriginalAttribute()) end
