...
function c60029.operation(e,tp,eg,ep,ev,re,r,rp)
	   ...
	   while tc do
		...
		local dg=Duel.GetMatchingGroup(c60029.filter,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
	   if dg:GetCount()>0 then
		Duel.BreakEffect()
		Duel.Destroy(dg,REASON_EFFECT)
	   end
end
function c60029.limit(e,c)
