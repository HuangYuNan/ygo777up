...
function c5200005.spfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x360)
end
function c5200005.spcon(c,e,tp,eg,ep,ev,re,r,rp)  
	return Duel.GetCurrentPhase()==PHASE_BATTLE_STEP and Duel.IsExistingMatchingCard(c5200005.spfilter,tp,LOCATION_MZONE,0,1,nil)
end
