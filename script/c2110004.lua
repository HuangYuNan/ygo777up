...
function c2110004.chkfilter(c)
	return c:IsFaceup() and c:IsCode(2110000)
end
...
function c2110004.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupEx(tp,c2110004.relfilte,1,nil) end
	local g=Duel.SelectReleaseGroupEx(tp,c2110004.relfilte,1,1,nil)
