...
function c18725601.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x266) and not c:IsCode(18725601)
end
function c18725601.spcon(e,c)
	if c==nil then return true end
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(c18725601.filter,c:GetControler(),LOCATION_MZONE,0,1,nil)
end
