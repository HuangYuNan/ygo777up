...
function c187199009.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0xabb),aux.NonTuner(Card.IsSetCard,0x3e1),1)
	c:EnableReviveLimit()
	--selfdes
	...
	e1:SetCondition(c187199009.regcon)
	e1:SetTarget(c187199009.regtg)
	e1:SetOperation(c187199009.regop)
	c:RegisterEffect(e1)
	--immune spell
	local e1=Effect.CreateEffect(c)
	...
	e1:SetRange(LOCATION_MZONE)
	e1:SetValue(c187199009.efilter)
	c:RegisterEffect(e1)
end
function c187199009.efilter(e,te)
...
function c187199009.regcon(e,tp,eg,ep,ev,re,r,rp)
...
function c187199009.regtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c187199009.regop(e,tp,eg,ep,ev,re,r,rp)
	local t=Duel.GetAttackTarget()
