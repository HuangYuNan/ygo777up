...
function c80005012.initial_effect(c)
	...
	e2:SetTarget(c80005012.indtg)
	e2:SetValue(c80005012.indval)
	c:RegisterEffect(e2)
	--atk
...
function c80005012.spfilter(c,e,tp)
	return c:GetTextAttack()==-2 and c:GetTextDefense()==-2 and c:IsRace(RACE_SPELLCASTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsType(TYPE_PENDULUM)
end
