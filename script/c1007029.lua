...
function c1007029.spfilter(c,e,tp)
	return c:IsSetCard(0x245) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(1007029)
end
...
function c1007029.filter(c)
	return c:IsSetCard(0x245) and (c:IsType(TYPE_SPELL) or c:IsType(TYPE_TRAP)) and c:IsAbleToHand()
end
