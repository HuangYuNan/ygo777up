...
function c18702321.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingTarget(c18702321.ffilter,tp,LOCATION_HAND,0,1,nil) end
	local g=Duel.GetMatchingGroup(c18702321.ffilter,tp,LOCATION_HAND,0,nil)
	Duel.SetOperationInfo(0,CATEGORY_TODECK,g,g:GetCount(),0,0)
end
function c18702321.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(tp,c18702321.ffilter,tp,LOCATION_HAND,0,1,1,nil)
