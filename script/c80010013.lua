...
function c80010013.initial_effect(c)
	...
	e2:SetCountLimit(1,80010013)
	e2:SetCondition(c80010013.condition1)
	e2:SetCost(c80010013.negcost)
	e2:SetTarget(c80010013.target)
	e2:SetOperation(c80010013.activate)
	c:RegisterEffect(e2)
	--negate
