...
function c30303007.initial_effect(c)
	...
	e3:SetCondition(c30303007.discon)
	e3:SetCost(c30303007.cost)
	e3:SetTarget(c30303007.distg)
	e3:SetOperation(c30303007.disop)
	c:RegisterEffect(e3)
end
...
function c30303007.discon(e,tp,eg,ep,ev,re,r,rp)
	if ep==tp then return false end
	return not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED) and Duel.IsChainNegatable(ev)
end
function c30303007.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
...
function c30303007.disop(e,tp,eg,ep,ev,re,r,rp)
