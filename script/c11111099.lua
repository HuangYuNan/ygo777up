...
function c11111099.cfilter(c)
	return c:IsSetCard(0x95) and (c:IsCode(11111006) or c:IsCode(11111018)) and c:IsDiscardable()
end
function c11111099.ovfilter(c)
	return c:IsFaceup() and c:GetCode()==11111011 and not c:IsHasEffect(EFFECT_CANNOT_BE_XYZ_MATERIAL)
end
...
function c11111099.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c11111099.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetCondition(c11111099.dcon)
	e2:SetOperation(c11111099.dop)
	c:RegisterEffect(e2)
end
function c11111099.dcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return ep~=tp and (c==Duel.GetAttacker() or c==Duel.GetAttackTarget())
end
function c11111099.dop(e,tp,eg,ep,ev,re,r,rp)
