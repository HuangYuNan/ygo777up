...
function c187199003.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c187199003.tgfilter,tp,LOCATION_GRAVE,0,1,nil) and Duel.IsEnvironment(187199010) end
