--暴虐公 夜刀神十香
function c1876044.initial_effect(c)
	--xyz summon
	...
	e2:SetCondition(c1876044.condition)
	e2:SetOperation(c1876044.operation)
	c:RegisterEffect(e2)
	--damage
	...
	e7:SetCondition(c1876044.damcon)
	e7:SetTarget(c1876044.damtg)
	e7:SetOperation(c1876044.damop)
	c:RegisterEffect(e7)
end
function c1876044.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c1876044.operation(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	local bc=c:GetBattleTarget()
...
function c1876044.damcon(e,tp,eg,ep,ev,re,r,rp)
...
function c1876044.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c1876044.damop(e,tp,eg,ep,ev,re,r,rp)
