...
function c5012605.initial_effect(c)
	...
	e0:SetDescription(aux.Stringid(5012605,3))
	e0:SetType(EFFECT_TYPE_FIELD)
	e0:SetCode(EFFECT_SPSUMMON_PROC)
	e0:SetProperty(EFFECT_FLAG_UNCOPYABLE)
	e0:SetRange(LOCATION_EXTRA)
	e0:SetCountLimit(1,55012605)
	e0:SetCondition(c5012605.overcon)
	e0:SetOperation(c5012605.overop)
	e0:SetValue(SUMMON_TYPE_XYZ)
	c:RegisterEffect(e0)
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(5012605,4))
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_SPSUMMON_PROC)
	e1:SetProperty(EFFECT_FLAG_UNCOPYABLE)
	e1:SetRange(LOCATION_EXTRA)
	e1:SetCondition(c5012605.spcon)
	e1:SetOperation(c5012605.spop)
...
function c5012605.over(c,g)
	return c:IsFaceup() and c:IsSetCard(0x350) and c:IsLevelAbove(7) and not c:IsType(TYPE_TOKEN)
...
function c5012605.ovfilter(c,g)
	return c:IsSetCard(0x350)  and c:IsFaceup() and c:IsLevelAbove(4) and c:IsCanBeXyzMaterial(g)
end
