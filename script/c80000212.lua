...
function c80000212.adtg1(e,c)
	return not c:IsRace(RACE_ROCK+RACE_MACHINE)
end
function c80000212.cfilter1(c)
	return c:IsFaceup() and (c:IsRace(RACE_ROCK) or c:IsRace(RACE_MACHINE))
end
...
function c80000212.spfilter(c,e,tp)
	return c:IsLevelBelow(3) and c:IsRace(RACE_ROCK) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
