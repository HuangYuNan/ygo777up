...
function c187199007.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingTarget(c187199007.desfilter,tp,0,LOCATION_MZONE,1,nil) and Duel.IsEnvironment(187199010) end
