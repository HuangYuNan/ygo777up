...
function c5012609.spfilter(c,e,tp)
	return c:IsSetCard(0x350) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsType(TYPE_TUNER)
end
...
function c5012609.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x350) and c:IsType(TYPE_PENDULUM)and c:IsAbleToHand()
end
