...
function c2100001.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return loc==LOCATION_MZONE and np==tp and re:IsActiveType(TYPE_MONSTER) and rc:IsSetCard(0x1219)
end
...
function c2100001.cfilter(c)
	return c:IsSetCard(0x1219) and not c:IsCode(2100001) and c:IsAbleToGraveAsCost()
end
