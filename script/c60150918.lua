...
function c60150918.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,c60150918.tfilter,aux.NonTuner(c60150918.tfilter),1)
	c:EnableReviveLimit()
	--special summon rule
	...
	e12:SetCondition(c60150918.spcon2)
	e12:SetOperation(c60150918.spop2)
...
function c60150918.sprfilter1(c,tp)
	...
	return c:IsFaceup() and c:IsType(TYPE_TOKEN) and c:IsSetCard(0x6b23) and c:IsCanBeSynchroMaterial()
		...
		or (c:IsFaceup() and c:IsType(TYPE_TOKEN) and c:IsSetCard(0x6b23) and lv==8)
end
