...
function c2100004.filter(c)
	return c:IsSetCard(0x1219) and c:IsType(TYPE_MONSTER) and c:IsAbleToRemoveAsCost()
end
...
function c2100004.filter1(c)
	return c:IsSetCard(0x1219) and not c:IsCode(2100004) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function c2100004.filter2(c)
	return c:IsFaceup() and c:IsSetCard(0x1219) and not c:IsType(TYPE_TUNER)
end
