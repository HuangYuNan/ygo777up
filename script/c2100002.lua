...
function c2100002.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x1219) and c:IsType(TYPE_MONSTER)
end
...
function c2100002.filter1(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x1219) and c:IsPosition(POS_FACEUP_ATTACK) 
end
