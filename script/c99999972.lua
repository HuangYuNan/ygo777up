...
function c99999972.spfilter(c,e,tp)
	return c:IsCanBeSpecialSummoned(e,0,tp,false,false) and  (c:IsSetCard(0x2e0) or c:IsSetCard(0x2e1))
end
...
function c99999972.spfilter2(c,e,tp,lv,att)
	...
	and (c:IsSetCard(0x2e0) or c:IsSetCard(0x2e1)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
