...
function c60151615.spfilter(c,sc)
    return c:IsSetCard(0xc204) and c:IsFaceup() and c:IsType(TYPE_XYZ+TYPE_SYNCHRO) and c:IsCanBeXyzMaterial(sc)
end
...
function c60151615.confilter(c)
    return c:IsSetCard(0xc204) and c:IsType(TYPE_MONSTER) 
end
...
function c60151615.efilter(e,ct)
    ...
    return te:IsActiveType(TYPE_MONSTER) and tc:IsSetCard(0xc204) 
